...
export const ENTERPRISE_ROLES: EnterpriseRoleTemplate[] = [
  ...
  // 13. AGENCY & PRINCIPAL REPRESENTATION DIVISION
  {
    id: "agency_director",
    department: "Agency & Principal Representation",
    deptId: "commercial",
    title: "Agency Business Head / VP Principal Representations",
    level: "EXECUTIVE",
    summary: "Principal dealership agreements, territory exclusivity, commission structure negotiation, and Annual Business Plan (ABP) targets.",
    permissions: ["commercial.view", "commercial.edit", "commercial.approve", "finance.view", "supply.view", "reports.print"],
    modules: ["Commercial Desk (/commercial/desk)", "Enquiry Funnel (/commercial/enquiry-funnel)", "Sales Register (/reports/sales-register)", "EXIM Hub (/commercial/exim)"],
    approvalScope: "Principal dealership contracts, agency indent quotations, commission settlement sign-off",
  },
  {
    id: "agency_sales_mgr",
    department: "Agency & Principal Representation",
    deptId: "commercial",
    title: "Agency Sales & Indenting Manager",
    level: "MANAGEMENT",
    summary: "Customer lead conversion, indent order booking, principal quotation generation, and commission realization pipeline.",
    permissions: ["commercial.view", "commercial.edit", "commercial.approve", "reports.print"],
    modules: ["Quotations (/commercial/quotations)", "Follow-ups (/commercial/follow-ups)", "Marketing (/commercial/marketing)", "Customer Exposure (/commercial/customer-exposure)"],
    approvalScope: "Agency indent offers, price discount recommendations, customer payment terms",
  },
  {
    id: "agency_principal_liaison",
    department: "Agency & Principal Representation",
    deptId: "commercial",
    title: "Principal Liaison & Commission Specialist",
    level: "SPECIALIST",
    summary: "Managing OEM principal communication, commission invoice generation, forex reconciliation, and agency shipment tracking.",
    permissions: ["commercial.view", "finance.view", "supply.view", "reports.print"],
    modules: ["Commercial Treasury (/commercial/treasury)", "EXIM Customs (/commercial/exim)", "Supplier Payables (/reports/supplier-payables)", "Sales Register (/reports/sales-register)"],
    approvalScope: "Commission invoice verification, OEM credit note reconciliation, shipping documentation",
  },
  {
    id: "agency_app_engineer",
    department: "Agency & Principal Representation",
    deptId: "commercial",
    title: "Field Application & Tooling Trial Specialist",
    level: "SPECIALIST",
    summary: "Customer shopfloor technical trials, cutting tool optimization, machine tool cycle-time demonstrations, and technical pre-sales.",
    permissions: ["engineering.view", "ops.view", "commercial.view"],
    modules: ["CNC Calculator (/engineering/cnc-calc)", "Tool Room (/ops/tool-room)", "Machine Specs (/system/machines)", "Customer Trials (/commercial/follow-ups)"],
    approvalScope: "Tooling trial reports, cutting parameter sign-off, technical recommendation release",
  },
  {
    id: "agency_service_eng",
    department: "Agency & Principal Representation",
    deptId: "commercial",
    title: "Principal Field Service & Commissioning Engineer",
    level: "SPECIALIST",
    summary: "On-site machine erection, commissioning, CNC control interfacing, warranty claims, and OEM authorized maintenance.",
    permissions: ["maintenance.view", "maintenance.edit", "ops.view", "reports.print"],
    modules: ["Maintenance Hub (/system/maintenance)", "Machine History (/reports/machine-history)", "Spares Catalog (/supply/spares)", "Service Log (/system/tickets)"],
    approvalScope: "Customer commissioning handover certificates, warranty claim validation, service visit reports",
  },
];
