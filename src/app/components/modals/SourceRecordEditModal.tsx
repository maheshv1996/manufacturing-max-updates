  ...
  return (
    <>
      <button
        type="button"
        onClick={handleOpen}
        title={`Edit ${title || entityType}`}
        aria-label={`Edit ${title || entityType}`}
      ...
      {isOpen && (
        <div
          role="dialog"
          aria-modal="true"
          aria-labelledby="source-record-modal-title"
        ...
        >
          <div
            ...
            className="bg-slate-800/60 border border-slate-700 rounded-2xl max-w-lg w-full p-6 shadow-2xl space-y-5 max-h-[90vh] overflow-y-auto"
          >
            <div className="flex items-center justify-between border-b border-slate-700 pb-3">
              <h3 id="source-record-modal-title" className="text-lg font-black flex items-center gap-2">
